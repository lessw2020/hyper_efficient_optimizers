# updates agd to use bf16 var state
# base code from https://github.com/intelligent-machine-learning/dlrover/blob/master/atorch/atorch/optimizers/agd.py
# paper/docs link:  https://github.com/intelligent-machine-learning/dlrover/blob/master/atorch/docs/README-AGD.md
...
class AGD16(torch.optim.Optimizer):
        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:
                ...
                if len(state) == 0:
                    ...
                    state["exp_avg_sq"] = torch.zeros_like(p, memory_format=torch.preserve_format, dtype= torch.bfloat16)
                    if group["amsgrad"]:
